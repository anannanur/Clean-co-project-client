    ...
    return (
        <div class="drawer drawer-end" data-theme={dark ? "dark" : "light"}>
            ...
            <div class="drawer-content flex flex-col">
                <div class="w-full navbar bg-base-100 lg:px-16 fixed top-0 z-30">
                    ...
                    <h1 class="flex-1 px-2 mx-2 text-2xl">Clean Co.</h1>
                    ...
                    <div class="flex-none hidden lg:block">
                        <ul class="menu menu-horizontal gap-x-2">
                            ...
                            {admin && <li><NavLink to="/dashboard/addService" className='rounded-lg'> Dashboard</NavLink></li>}
                            <li><NavLink to="/about" className='rounded-lg'> About</NavLink></li>
                            <li><NavLink to="/services" className='rounded-lg'> Services</NavLink></li>
                            <li><NavLink to="/contact" className='rounded-lg'> Contact</NavLink></li>
                            <li><NavLink to="/login" className='rounded-lg'> Login</NavLink></li>
                            <li class="dropdown dropdown-hover dropdown-end">
                                <label tabindex="0" class="btn btn-primary rounded-lg btn-outline">Book Now</label>
                ...
                <ul class="menu p-4 overflow-y-auto w-80 bg-base-200">
                    ...
                    <div tabindex="0" class="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
                        ...
                        <li class="collapse-content">
                            ...
                            <NavLink to="/about">Pre Book</NavLink>
                        </li>
                    </div>
